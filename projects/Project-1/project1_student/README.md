...
## Grading
* We have our own test suite based on the specifications given to you; passing these tests will make up a sizable chunk of your grade.  So while you aren't required to write your own test cases, it is highly encouraged.  Please refer to PS1 and PS2 for templates for how to write your own tests.
* Pay special attention to restrictions for each problem (i.e. Can you use var/val? Can you use a loop?).  Failure to adhere to the guidelines will result in a significant point deduction.

### Writing tests

In the spirit of encouraging test-driven development (TDD), we highly recommend that you write your own tests for this project. Tests will not be provided, and any tests that you write will not be graded - it is entirely up to you to decide the nature and quantity of your tests.
